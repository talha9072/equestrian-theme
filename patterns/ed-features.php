...
/**
 * Title: ED Features
 * Slug: equestrian-theme/ed-features
...
<section class="wp-block-group section has-cream-deep-background-color has-background" style="padding-top:92px;padding-bottom:92px">
    ...
    <div class="wp-block-group container">
        ...
        <div class="wp-block-group section-head center">
            ...
            <h2 class="wp-block-heading display">The real stuff, with an equestrian twist</h2>
            <!-- /wp:heading -->
        ...
        <div class="wp-block-group themes-grid">
            ...
            <div class="wp-block-group theme-card">
                ...
                <!-- /wp:html -->
                <!-- wp:heading {"level":3} -->
                <h3 class="wp-block-heading">Wins &amp; losses</h3>
                <!-- /wp:heading -->
                <!-- wp:paragraph -->
            ...
            <div class="wp-block-group theme-card">
                ...
                <!-- /wp:html -->
                <!-- wp:heading {"level":3} -->
                <h3 class="wp-block-heading">Peer pressure</h3>
                <!-- /wp:heading -->
                <!-- wp:paragraph -->
            ...
            <div class="wp-block-group theme-card">
                ...
                <!-- /wp:html -->
                <!-- wp:heading {"level":3} -->
                <h3 class="wp-block-heading">Finding your way</h3>
                <!-- /wp:heading -->
                <!-- wp:paragraph -->
